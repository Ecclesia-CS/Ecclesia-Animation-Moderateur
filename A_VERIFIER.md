...
- [ ] **2026-09-06 — Chantier 59 — `supabase/migrations/20260906_chantier59_realtime_canaux_prives.sql`** (jamais appliquée) — canaux Realtime privés, F6 à la racine

  **⛔ NE RIEN APPLIQUER NI DÉPLOYER AVANT LA SÉANCE DU JEUDI 10 SEPTEMBRE.** Branche `chantier-59-realtime-prive`, non destinée à être mergée avant cette date.
