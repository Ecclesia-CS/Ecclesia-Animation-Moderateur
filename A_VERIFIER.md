...
## Chantier 113 (2026-09-21) — « Mes binômes » retiré du débat, remplacé par « Changer de table » — ✅ vérifié en base ET au navigateur réel
...
**Vérifié au navigateur réel le 2026-09-21** (dev server local sur ce worktree, `.env` copié depuis le dossier racine, séance et deux tables jetables créées/purgées en base — `sessions.title = '🧪 QA chantier 113 (jetable)'`, join_codes `QA113A`/`QA113B`) :
