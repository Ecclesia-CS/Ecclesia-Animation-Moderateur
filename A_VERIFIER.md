...
1. **Migration SQL en attente** (ci-dessous) — à appliquer avant de tester le chantier 33 et le chantier 44.
...
4. **Modérateur** (`ModeratorView`) — Code Ecclesia + vraie table animée requis. Couvre aussi le chantier 44 ("Ajouter une personne sans téléphone").
