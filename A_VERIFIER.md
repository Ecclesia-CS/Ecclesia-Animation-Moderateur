...
**Restent à jouer à l'écran** (recette conservée ci-dessous ; les points barrés sont faits) : (séance en phase `allocating` ou `debating`, onglet Groupes du superadmin) :
