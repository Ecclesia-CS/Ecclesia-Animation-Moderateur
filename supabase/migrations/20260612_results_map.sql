-- =============================================================
-- get_results_map : carte d'opinion anonymisée pour un participant
-- après la clôture de la séance (phase='closed').
-- SECURITY DEFINER nécessaire : analysis_members a SELECT USING(false).
-- Pas de mot de passe : RPC participant-facing, sécurisé par auth.uid().
-- =============================================================
