...
>
> 🗂️ **[docs/A_VERIFIER-passe-validation-jules-20260906.md](./docs/A_VERIFIER-passe-validation-jules-20260906.md)** — la passe de validation manuelle de Jules du 06/09/2026 : 33 entrées qu'il a réellement vérifiées à l'écran et déplacées en « Validé ». Elle n'a **pas** encore été réintégrée dans `A_VERIFIER.md`, parce que quatre chantiers y ont ajouté leurs sections depuis et que la fusion demande un arbitrage. **Croiser les deux fichiers avant de considérer un point comme ouvert** : il a peut-être déjà été validé. Ne pas supprimer ce fichier, c'est la seule trace de ce travail.
