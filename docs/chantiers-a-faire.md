...
### 123 — Diagnostic modération/binôme + promotion par DnD
**Branche** : `claude/chantier-123-diagnostic-cf7237` · **Depuis** : 2026-09-22 · **Fichiers touchés** : `src/lib/allocation.ts` (+ tests), `src/lib/voting.ts`, `src/screens/SuperadminScreen.tsx` (onglet Groupes), `supabase/migrations/20260922_chantier123_moderation_effective.sql` (migration **appliquée en base**).
